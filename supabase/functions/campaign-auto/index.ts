...
/* Declaring the colour scheme is what stops Apple Mail and Gmail inverting
   this in dark mode: a cream header going charcoal and the navy footer going
   muddy, which is the usual reason a good email suddenly looks wrong on
   somebody's phone. Everything below already sets its own background
   explicitly, which is the other half of the fix. */
// deno-lint-ignore no-explicit-any
